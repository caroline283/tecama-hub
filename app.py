...
with st.sidebar:
    ...
    st.caption("Tecama Hub Industrial v8.4")
            ...
            if st.button("🚀 Gerar Planilha de Produção"):
                ...
                with pd.ExcelWriter(output, engine="openpyxl") as writer:
                    ...
                    for col in ws.columns:
                        ...
                        ws.column_dimensions[column].width = max_length + 4 if column != 'G' else 35
